            ...
            <div class="flex flex-col mx-4 items-center md:basis-2/3">
                <div class="bg-white shadow sm:rounded-lg w-full">
                    <div class="px-4 py-5 sm:p-6">
                        <div class="md:flex md:flex-row items-center px-4">
                            <div class="flex flex-col items-center w-full">
                                        ...
                                        <fieldset class="mt-4">
                                          ...
                                          <div class="space-y-4 sm:flex sm:items-center sm:space-x-10 sm:space-y-0">
                                            <div class="flex items-center">
                                              <input id="email" name="topics[]" type="checkbox" checked value="web_development" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                              <label for="email" class="ml-3 block text-sm font-medium leading-6 text-gray-900">Web Development</label>
                                            </div>
                                            <div class="flex items-center">
                                              <input id="sms" name="topics[]" type="checkbox" value="web_design" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                              <label for="sms" class="ml-3 block text-sm font-medium leading-6 text-gray-900">Web Design</label>
                                            </div>
                                            <div class="flex items-center">
                                                <input id="push" name="topics[]" type="checkbox" value="database" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                                <label for="push" class="ml-3 block text-sm font-medium leading-6 text-gray-900">Databases</label>
                                              </div>
                                            <div class="flex items-center">
                                              <input id="push" name="topics[]" type="checkbox" value="startups" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                              <label for="push" class="ml-3 block text-sm font-medium leading-6 text-gray-900">Startups</label>
                                            </div>
                                            <div class="flex items-center">
                                                <input id="push" name="topics[]" type="checkbox" value="scifi" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                                <label for="push" class="ml-3 block text-sm font-medium leading-6 text-gray-900">SciFi</label>
                                            </div>
                                          </div>
                                        </fieldset>
                                      </div>
                                ...
                                <div class="w-full md:flex mt-4 md:flex-row md:content-center md:items-center md:w-3/4 tw-email-input">
                                    <div class="w-full md:w-3/4 relative rounded-md shadow-sm">
                                    ...
                                    <button type="button" class="w-full md:w-auto md:ml-2 mt-4 md:mt-none rounded-md bg-indigo-600 px-3.5 py-2.5 md:mt-none text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Show Me Some Books!</button>
                                </div>
                            </div>
